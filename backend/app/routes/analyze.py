...
async def analyze_submission(
    ...
    try:
        ...
        return AnalysisResultResponse(
            ...
            scam_score=pipeline_res.get("scam_score", 0),
            risk_level=pipeline_res.get("risk_level", "Low Risk"),
            language=pipeline_res.get("language", "en"),
            risk_factors=pipeline_res.get("linguistic_data", {}),
            verification_data=pipeline_res.get("verification_data", {}),
            explanation_text=pipeline_res.get("explanation_text", ""),
            recommendations=pipeline_res.get("recommendations", []),
